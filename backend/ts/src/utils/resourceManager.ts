...
interface iStringResource {
    ...
    logged_out_failure_msg: string,
    logged_out_success_msg: string,
    access_token_not_set: string,
    access_token_invalid: string,
    unathorized_role_msg: string,
...
const R: iR = {
    ...
    logged_out_failure_msg:  "Authentication is required",
    logged_out_success_msg:  "Logged out successfully",
    access_token_not_set:  "Access token is missing",
    access_token_invalid:  "jwt malformed",
    unathorized_role_msg:  "User does not have a required role",
